...
%prep
%setup -q -n DateTime-Format-Strptime-1.79
cd %{_builddir}/DateTime-Format-Strptime-1.79
...
cp %{_builddir}/DateTime-Format-Strptime-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-DateTime-Format-Strptime/83111739ffdf88a3b10c17ec4c2af2aa1c7a9773 || :
if test -f Makefile.PL; then
